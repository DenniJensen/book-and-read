...
# For development, you may want to listen on port 3000 so that you can make
# sure  your unicorn.rb file is soundly configured.
...
# Set the location of the unicorn pid file. This should match what we put in
# the unicorn init script later.
pid app_path + '/tmp/unicorn.pid'

# # You should define your stderr and stdout here. If you don't, stderr
# defaults to /dev/null and you'll lose any error logging when in daemon mode.
